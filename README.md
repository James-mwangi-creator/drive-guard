...
Uses phone sensors to detect nearby objects and prevent driving collisions

## ✨ Features
- Real-time proximity detection\n- Collision vibration alerts\n- Speed-sensitive danger zones\n- Obstacle distance tracking\n- Background sensor monitoring
...
- [Repository](https://github.com/James-mwangi-creator/drive-guard)
- [Actions](https://github.com/James-mwangi-creator/drive-guard/actions)
